...
const SEQUENCE: SeqItem[] = [
  ...
  },
  {
    id: 1,
    type: "image",
    src: "/api/media/website/home/hero/2.webp",
    title: "RN Premium\nBath Series",
    subtitle: "Discover",
    duration: 5000,
  },
  {
    id: 2,
    type: "image",
    src: "/api/media/website/home/hero/3.webp",
    title: "RN Polymer\nCollection",
    subtitle: "Curated",
    duration: 5000,
  },
...
export default function Home() {
  const [homeSetting, setHomeSetting] = useState<any>(null);
  ...
  const heroSequence: SeqItem[] =
    homeSetting?.hero &&
    homeSetting.hero.filter((h: any) => h.active !== false && Boolean(h.src)).length > 0
  ...
  return (
    ...
    >
      ...
      {/* ── 8. Blogs ── */}
      <BlogsSection data={homeSetting?.blogsSection} />
