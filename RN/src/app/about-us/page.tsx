        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
            ...
            >
              ...
              <span style={{ color: ACCENT }}>
                Faucets and Plumbing Systems in india.
              </span>
            </h2>
            ...
            >
              We are committed towards constant innovations in plumbing, irrigation
              and sewerage technologies to meet the nation&apos;s constantly increasing
              water demands. RN Valves constantly strives to pave the way for a future
              that provides clean water for everyone and everywhere; from the smallest
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-stretch min-h-[280px] flex-1 max-h-[420px]">
            ...
            >
              ...
              >
                To be an acknowledged leader in Indian plastic Faucets industry by
                exceeding customers expectations and maximizing bottom line for all
                our stake holders.
              </p>
            </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <span style={{ color: ACCENT }}>pan-India distributor base</span> to
              ensure customer proximity and readiness to address their needs.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div style={{ display: "flex", flexDirection: "column", gap: "22px" }}>
              ...
              >
                <span style={{ color: ACCENT }}>State-Of-The-Art.</span>{" "}
              ...
              >
                Our manufacturing framework is built around advanced machinery and
                computerized injection moulding processes that deliver consistent,
                high-precision output at scale — so every product meets the same
                quality standard, every time.
              </p>
              ...
              >
                {MANUFACTURING_FEATURES.map((feature) => (
                  <div
                    key={feature}
                    style={{
                      display: "flex",
