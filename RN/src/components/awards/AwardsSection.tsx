      ...
      <div className="relative z-[1] mx-auto flex w-full max-w-[1240px] flex-col items-center gap-10 md:gap-12 lg:gap-14">
        <div id="awards-heading">
          <SectionHeading
            ...
            description="Celebrating our commitment to quality, innovation, customer trust, and manufacturing excellence through nationally recognized achievements and industry honors."
          />
        </div>
