...
const INSTAGRAM_PROFILE = "https://www.instagram.com/hindware/";
...
const SOCIALS = [
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/hindware",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden>
        <path
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@hindware",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden>
        <path
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/hindware",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden>
        <path
  ...
  {
    label: "Pinterest",
    href: "https://www.pinterest.com/hindwarehomes/",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden>
        <path
