...
const SUPPORT_CARDS = [
  {
    title: "Store Locator",
    description: "Purchase our products from Jaquar authorized dealers only.",
    cta: "Find a Store",
    href: "#",
    image:
...
export default function JaquarSupportSection() {
  ...
  return (
    <section
      ...
      aria-label="Store locator and Jaquar care"
    >
      <style>{`
        .jaquar-support-grid {
          display: grid;
