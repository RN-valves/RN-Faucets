...
const TRUST_ITEMS: TrustItem[] = [
  ...
  {
    title: "Professional Installation - Hindware approved installation available*.",
    description: "Benefit from professional brand installation services.",
    linkLabel: "Find Out More",
    href: "#",
  },
  {
    title: "Assistance from Hindware specialists, Live Chat.",
    description:
      "Live chat with Hindware product specialist and find your right product.",
  },
];
...
export default function WhyBuySection() {
  ...
  return (
    <section
      ...
      aria-label="Why Buy from Hindware Directly"
    >
      <style>{`
        .why-buy-link {
          color: #111111;
      ...
      >
        Why Buy from Hindware Directly
      </h2>
